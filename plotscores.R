#
# This file reads in the sentiment scores of airline tweets created by file generatescores.R 
# It then creates some standard plots which can be used to compare sentiments expressed towards airlines
# The data is read from an RDS file (assumed to be "scores.rds")
